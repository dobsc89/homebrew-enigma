class ElasticsearchAT1 < Formula
  ...
  url "https://download.elastic.co/elasticsearch/elasticsearch/elasticsearch-1.0.3.tar.gz"
  sha256 "36dd561fd967f9cb38b30b6e512f1c76f501f7ba05a228b2ed2b413d9561ee42"
  revision 1
  ...
  plist_options :manual => "elasticsearch --config=#{HOMEBREW_PREFIX}/opt/elasticsearch@1/config/elasticsearch.yml"
